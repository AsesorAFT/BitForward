...
class NotificationSystem {
  ...
  contractCreated(contractId, blockchain, amount) {
    this.success(`Contrato creado exitosamente en ${blockchain.toUpperCase()}`, {
  ...
  contractExecuted(contractId, pnl) {
    ...
    this[method](`Contrato ejecutado ${isProfitable ? 'con ganancias' : 'con pérdidas'}`, {
  ...
  walletConnected(blockchain, address) {
    this.success(`Wallet ${blockchain.toUpperCase()} conectada`, {
  ...
  networkError(message) {
    this.error('Error de conexión con la blockchain', {
      details: message,
      duration: 8000,
    });
  }
