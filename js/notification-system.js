...
class NotificationSystem {
  ...
  createNotificationBell() {
    ...
    const userArea =
      header.querySelector('.user-actions, .user-menu, .header-actions') ||
  ...
  addNotification(notification) {
    ...
    window.dispatchEvent(
      new CustomEvent('bf-notification-added', {
        detail: { notification },
      })
    );
  }
  ...
  renderNotifications() {
    ...
    const activeFilter = document.querySelector('.notification-filters button.active').dataset
      .filter;
    let filteredNotifications = this.getFilteredNotifications(activeFilter);
  ...
  toggleReadStatus(id) {
    ...
    if (notification) {
      ...
      if (notificationEl) {
        ...
        notificationEl.querySelector('.mark-read i').className =
          `fas ${notification.read ? 'fa-envelope-open' : 'fa-envelope'}`;
      }
    }
  }
