...
class NewsFeed {
    ...
    return [
      {
        ...
        summary:
          'La criptomoneda líder ha alcanzado un nuevo máximo histórico impulsada por la demanda institucional y la adopción empresarial.',
        source: 'CoinDesk',
        url: '#',
      ...
      },
      {
        ...
        summary:
          'El BCE ha comenzado la fase de pruebas para implementar una versión digital del euro, enfocada en soluciones empresariales y pagos transfronterizos.',
      ...
      },
      {
        ...
        summary:
          'La blockchain Solana ha implementado su actualización "Phoenix", multiplicando por diez su capacidad de procesamiento anterior.',
        source: 'Decrypt',
        url: '#',
      ...
      },
      {
        ...
        summary:
          'El regulador estadounidense ha dado luz verde a tres fondos cotizados de Ethereum, abriendo la puerta a mayor inversión institucional.',
      ...
      },
      {
        ...
        summary:
          'El sector de las finanzas descentralizadas continúa creciendo, superando los $500 mil millones en TVL, con protocolos empresariales liderando la adopción.',
      ...
      },
      {
        ...
        summary:
          'Empresas como AFORTU Holdings están liderando la adopción de contratos forward en blockchain, ofreciendo soluciones para gestión de riesgos corporativos.',
        source: 'DeFi Pulse',
        url: '#',
      ...
      },
      {
        ...
        summary:
          'El gobierno chino continúa la implementación de su CBDC, ahora disponible en 20 ciudades adicionales con nuevas funcionalidades para empresas.',
        source: 'Coindesk',
        url: '#',
      ...
      },
      {
        ...
        summary:
          'El gigante bancario ha presentado una solución similar a BitForward, dirigida a clientes corporativos para gestionar exposición a criptoactivos.',
        source: 'The Block',
        url: '#',
  ...
  createNewsItemHTML(newsItem) {
    ...
    // Topic badges
    const topicBadges = newsItem.topics
      .map(topic => `<span class="news-topic-badge">${topic}</span>`)
      .join('');
  ...
  filterNewsByTopic(topic) {
    ...
    const filteredNews = this.newsCache.filter(news => news.topics.includes(topic));
