class UniversalFooter {
    constructor() {
        this.containerId = 'bf-universal-footer-container';
        this.render();
    }
        ...
        return `
            <footer class="bf-universal-footer">
                <div class="bf-footer-container">
                    ...
                    <div class="bf-footer-logo-section">
                        <div class="bf-footer-logo">
                            <img src="/assets/img/logo-astronaut-dark.svg" alt="BitForward Logo">
                            <span>BitForward</span>
                        </div>
                        <p class="bf-footer-tagline">Plataforma líder en finanzas descentralizadas y trading de activos del futuro.</p>
                    </div>
                    ...
                    <div class="bf-footer-bottom">
                        <p>&copy; ${currentYear} BitForward. Todos los derechos reservados.</p>
                        <div class="bf-footer-socials">
                            <!-- Usaremos los iconos SVG directamente aquí para no depender de otra librería -->
                            <a href="https://x.com" target="_blank" aria-label="Twitter">${this.getIcon('twitter')}</a>
                            <a href="https://telegram.org" target="_blank" aria-label="Telegram">${this.getIcon('telegram')}</a>
                            <a href="https://discord.com" target="_blank" aria-label="Discord">${this.getIcon('discord')}</a>
                            <a href="https://github.com" target="_blank" aria-label="GitHub">${this.getIcon('github')}</a>
                        </div>
                    </div>
