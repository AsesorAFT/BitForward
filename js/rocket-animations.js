...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    launchButton = document.querySelector(
      '.launch-button, .cta-button, .primary-button, button.primary'
    );
  ...
  function launchRandomRocket() {
    ...
    const nextRocketDelay =
      Math.random() * (CONFIG.rocketFrequency.max - CONFIG.rocketFrequency.min) +
