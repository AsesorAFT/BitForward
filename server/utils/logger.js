...
class BitForwardLogger {
  ...
  createModuleLogger(moduleName) {
    return {
      info: (message, metadata = {}) =>
        this.info(`[${moduleName}] ${message}`, metadata),
      warn: (message, metadata = {}) =>
        this.warn(`[${moduleName}] ${message}`, metadata),
      error: (message, metadata = {}) =>
        this.error(`[${moduleName}] ${message}`, metadata),
      debug: (message, metadata = {}) =>
        this.debug(`[${moduleName}] ${message}`, metadata)
    };
  }
